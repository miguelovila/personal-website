...
export const education = [
  {
    ...
    subtitle: "Escola Secundária de Estarreja, Estarreja",
    start: "2018",
    end: "2021",
    description:
      "Graduated from Escola Secundária de Estarreja. I loved maths and phisics, and developed a passion for technology and programming as a self-taught hobby.",
  },
  {
    title: "Bachelor's Degree in Computer Engineering and Telematics",
    subtitle: "Universidade de Aveiro, Aveiro",
    start: "2021",
    end: "2024",
    description:
  ...
  {
    title: "Master's Degree in Computer and Telematics Engineering",
    subtitle: "Universidade de Aveiro, Aveiro",
    start: "2024",
    end: "Present",
    description:
